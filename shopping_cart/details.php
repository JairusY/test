<?php
    ...
    if(isset($_POST['btnProcess'])) {
        if(isset($_SESSION['cartItems'][$_POST['key']][$_POST['radSize']]))
            $_SESSION['cartItems'][$_POST['key']][$_POST['radSize']] += $_POST['txtQuantity']; 
        else
            $_SESSION['cartItems'][$_POST['key']][$_POST['radSize']] = $_POST['txtQuantity']; 
            ...
            <div class="row">
                <?php if(isset($_GET['k']) && isset($arrProducts[$_GET['k']])): ?>
                    ...
                    <div class="col-md-8 col-sm-6 mb-4">                
                        ...
                        <hr>
                        <input type="hidden" name="key" value="<?php echo $_GET['k']; ?>">
